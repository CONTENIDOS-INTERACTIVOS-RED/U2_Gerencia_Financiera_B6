        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 El análisis financiero es esencial para evaluar la situación económica de una empresa y orientar la toma de decisiones estratégicas. Incluye herramientas como el análisis de liquidez, rentabilidad y solvencia, permitiendo identificar fortalezas y debilidades. El análisis horizontal y vertical facilita la evaluación de tendencias y estructuras financieras, optimizando costos y maximizando beneficios. Además, los indicadores financieros apoyan la gestión sostenible, integrando aspectos económicos, sociales y ambientales. Su correcta aplicación permite mejorar la rentabilidad, reducir riesgos y fortalecer la competitividad empresarial en el mercado.
